...
<div class="panel panel-default" id="manage-customfields">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            @endif
            <form action="{{ route('plugin.nmscustomfields.customfield.update', $customfield) }}" method="POST" role="form" class="form-horizontal device-group-form col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2 col-sm-12">
